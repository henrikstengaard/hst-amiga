namespace Hst.Amiga.FileSystems.FastFileSystem.Blocks
{
    ...
    /// <summary>
    /// Reader for long name file system dir block (LNFS) present in DOS\6 and DOS\7
    /// </summary>
    public static class LongNameFileSystemDirBlockReader
    {
        public static DirBlock Read(byte[] blockBytes)
        {
            var type = BigEndianConverter.ConvertBytesToInt32(blockBytes);
            
            if (type != Constants.T_HEADER)
            {
                throw new IOException("Invalid long name file system dir block type");
            }
            ...
            {
                throw new IOException("Invalid long name file system dir block checksum");
            }
            ...
            {
                throw new IOException($"Invalid long name file system dir block sec type '{type}'");
            }
