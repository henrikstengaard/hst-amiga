namespace Hst.Amiga.FileSystems.FastFileSystem.Blocks
{
    ...
    public static class DirBlockBuilder
    {
        public static byte[] Build(DirBlock dirBlock, int blockSize)
        {
            ...
            BigEndianConverter.ConvertUInt32ToBytes(dirBlock.Access, blockBytes, 0x140);
            BigEndianConverter.ConvertUInt32ToBytes(0, blockBytes, 0x144); // reserved / byte size
            ...
            BigEndianConverter.ConvertUInt32ToBytes(dirBlock.RealEntry, blockBytes, 0x1d4);
            BigEndianConverter.ConvertUInt32ToBytes(dirBlock.NextLink, blockBytes, 0x1d8);

            BigEndianConverter.ConvertUInt32ToBytes(dirBlock.NextSameHash, blockBytes, 0x1f0);
            BigEndianConverter.ConvertUInt32ToBytes(dirBlock.Parent, blockBytes, 0x1f4);
            BigEndianConverter.ConvertUInt32ToBytes(dirBlock.Extension, blockBytes, 0x1f8);
